...
- Table \@ref(tab:phyla-before-adjust) shows an overview of the phyla representation in the data set ordered by counts > taxa > prevalence. So the most abundant phylum with most taxa and most prevalence is on top.
...
We checked how well the taxa in the abundance table have been annotated at the different taxonomic levels. Table \@ref(tab:tax-completion) shows the results.
