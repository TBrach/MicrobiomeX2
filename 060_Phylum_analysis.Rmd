...
bar_plot_ps_ra <- plot_sample_bars(physeq = ps_ra, x = "Sample", y = "Abundance", group_var = group_var, color_levels = color_levels, fill = "Phylum", color_sample_names = TRUE, col_vec = phylum_colors, facet_grid = NULL, order_by_firmicutes = TRUE)
```
...
taxa_annotation <- get_taxon_names(as.data.frame(tax_table(physeq_to_test)))
# --
