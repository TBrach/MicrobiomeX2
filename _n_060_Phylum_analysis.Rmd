...
- this extra analysis uses the unfiltered phyloseq object, since it is fully based on ratio analyses (for example Bacteroidetes to Firmicutes ratio) or relative abundances, it is independent of size factor/library size adjustments
...
- *NB: because based on ratios these analyses are independent of library size adjustment and compositionality*
